      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            >
              <path
                d="M50 85C50 85 20 65 20 40C20 30 25 20 35 20C42 20 47 25 50 30C53 25 58 20 65 20C75 20 80 30 80 40C80 65 50 85 50 85Z"
                fill="#E91E63"
                stroke="#C2185B"
                strokeWidth="2"
              />
              <path d="M50 30C50 30 45 35 45 45L55 45C55 35 50 30 50 30Z" fill="#F48FB1" />
            </svg>
